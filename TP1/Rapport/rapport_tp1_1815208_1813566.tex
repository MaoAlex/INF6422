...
En nous situant dans un contexte d'optimisation, toujours en référant à l'article, nous pouvons situer notre double-tétraèdre 
Il faut prendre ne compte les différentes stratégies possibles pour éviter les attaques redondantes pour l'attaquant. Au niveau du défenseur, il faudrait penser à un réseau le segmenté possible pour restreindre l'accès aux autres sous-réseaux.
...
L'environnement externe sur lequel nous ne pouvons pas agir. C'est-à-dire l'aspect matériel et logiciel du réseau. 

Les aspects du tétraèdres qui sont modifiés sont :
La topologie du réseau. La diminution du nombre de machines infectées. Les caractéristiques du ver. L'augmentation du nombre de machines infectées. 
\end{homeworkSection}
