...
immunisées contre cet agent pathogène et donc que nous ne pouvons pas nous trouver dans le cas du modèle SIR. Ainsi comme cet article étudie simplement l'évolution de l'infection d'un ensemble de machines dans différentes configurations données, nous pouvons donc penser que c'est bien le modèle SI qui s'appliquerait.
}
\end{homeworkSection}
