...
automatique est l'utilisation de synonymes pour les mots. Le spammeur pourrait avoir une liste de synonymes/différentes phrases
...
meilleur résultat.  C'est donc cette méthode qui semblent donner les meilleures performances pour le jeu de données spambase
\end{homeworkSection}
...
reçoive. (On considère que les spam envoie rarement plusieurs fois le même message aux utilisateurs). On pourrait également
...
on pourra bloquer les mails ayant une large liste de destinataires, car ceux-ci sont susceptibles d'être du spam.
\end{homeworkSection}
